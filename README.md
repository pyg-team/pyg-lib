...
* `${CUDA}` should be replaced by either `cpu`, `cu118`, `cu121`, `cu124`, `cu126`, or `cu128`

The following combinations are supported:

| PyTorch 2.7  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      |         |         | ✅      | ✅      |
| **Windows**  | ✅    | ✅      |         |         | ✅      | ✅      |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.6  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      |         | ✅      | ✅      |         |
| **Windows**  | ✅    | ✅      |         | ✅      | ✅      |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.5  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      | ✅      |         |         |
| **Windows**  | ✅    | ✅      | ✅      | ✅      |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.4  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      | ✅      |         |         |
| **Windows**  | ✅    | ✅      | ✅      | ✅      |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.3  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      |         |         |         |
| **Windows**  | ✅    | ✅      | ✅      |         |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.2  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      |         |         |         |
| **Windows**  | ✅    | ✅      | ✅      |         |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.1  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      |         |         |         |
| **Windows**  | ✅    | ✅      | ✅      |         |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 2.0  | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    | ✅      | ✅      |         |         |         |
| **Windows**  | ✅    | ✅      |         |         |         |         |
| **macOS**    | ✅    |         |         |         |         |         |

| PyTorch 1.13 | `cpu` | `cu118` | `cu121` | `cu124` | `cu126` | `cu128` |
|--------------|-------|---------|---------|---------|---------|---------|
| **Linux**    | ✅    |         |         |         |         |         |
| **Windows**  | ✅    |         |         |         |         |         |
| **macOS**    | ✅    |         |         |         |         |         |
