...
def test_spline_basis(degree, dtype):
    ...
    basis_ref, wi_ref = spline_basis_ref(
        pseudo,
        kernel_size,
        is_open_spline,
        degree,
...
def test_spline_weighting(dtype):
    ...
    out_ref = spline_weighting_ref(x, weight, basis, weight_index)
...
def test_spline_basis_against_torch_spline_conv(degree, dtype):
    ...
    basis, wi = spline_basis_ref(pseudo, kernel_size, is_open_spline, degree)
...
def test_spline_weighting_against_torch_spline_conv(dtype):
    ...
    out = spline_weighting_ref(x, weight, basis, weight_index)
