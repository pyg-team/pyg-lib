...
def test_grouped_matmul_autograd():
	...
	others = [torch.randn((16, 32),requires_grad=True,device='cuda:0'), torch.randn((32, 64),requires_grad=True,device='cuda:0')]
	...
	assert outs[1] == all(inputs[1] @ others[1]).all()
...
>>>>>>> 4422907bd283fa7b597153531cc6ddde1a39b35e
