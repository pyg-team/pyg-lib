...
- Added support for PyTorch `2.12.0` wheels in nightly releases ([#615](https://github.com/pyg-team/pyg-lib/pull/615), [#629](https://github.com/pyg-team/pyg-lib/pull/629))
