...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  py::class_<pyg_distributed::PicklableSHMMessageQueue>(m, "shm")
      ...
      .def("GetMPProcessSHMAddr",
           &pyg_distributed::PicklableSHMMessageQueue::GetMPProcessSHMAddr)
      .def("GetNumOfSamples",
           &pyg_distributed::PicklableSHMMessageQueue::GetNumOfSamples)
      .def("WriteDictOfTensors",
           &pyg_distributed::PicklableSHMMessageQueue::WriteDictOfTensors)
      .def("ReadDictOfTensors",
           &pyg_distributed::PicklableSHMMessageQueue::ReadDictOfTensors)
      ...
      .def(py::pickle(
          ...
          [](py::tuple t) {
            return pyg_distributed::PicklableSHMMessageQueue{t[0].cast<int>(),
                                                             t[1].cast<bool>()};
          }));
}
