...
// Explicit non-template comparison/min/max functions to avoid ambiguous
// operator overload errors from c10::SymInt on ROCm/HIP. These provide
// unambiguous overload resolution for float/double in kernels.
